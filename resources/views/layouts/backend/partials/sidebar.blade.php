...
<nav class="side-nav">
    <a href="" class="intro-x flex items-center pl-5 pt-4">
        <img alt="Midone Tailwind HTML Admin Template" class="w-6" src="{{asset('admin_assets')}}/images/logo.svg">
    ...
    <ul>
        ...
        <li>
            <a href="{{ route('admin.tag.index') }}"  class="side-menu {{  Request::is ('admin/tag*') ? 'side-menu--active' :'' }}">
                <div class="side-menu__icon"> <i data-feather="home"></i> </div>
                <div class="side-menu__title"> Tag </div>
            </a>
        </li>
        <li>
            <a href="{{ route('admin.category.index') }}"  class="side-menu {{  Request::is ('admin/category*') ? 'side-menu--active' :'' }}">
                <div class="side-menu__icon"> <i data-feather="home"></i> </div>
        ...
        <li>
            <a href="{{ route('author.dashboard') }}" class="side-menu {{  Request::is ('author/dashboard') ? 'side-menu--active' :'' }}">
                <div class="side-menu__icon"> <i data-feather="home"></i> </div>
                <div class="side-menu__title"> Dashboard </div>
            </a>
        </li>
